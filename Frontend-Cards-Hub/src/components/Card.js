...
const Card = ({ id, title, description, column, handleCardClick, handleDragStart, handleDelete }) => {
  const formatDate = () => {
    ...
    <div className="card" onClick={() => handleCardClick({ id, title, description, column })} draggable onDragStart={(e) => handleDragStart(e, id)}>
      ...
      <div className="card-footer d-flex justify-content-between align-items-center">
        ...
        <div className="d-flex align-items-center">
          <Button variant="danger" className="btn-sm me-2" onClick={() => handleDelete(id)}>Delete</Button> {/* Use Button component */}
